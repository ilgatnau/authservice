...
type Config struct {
	...
	// The Authservice provides an HTTP server to serve jwks within the mesh.
	// This is required in some specific use cases where JWKS endpoint is behind a proxy
	// and envoy proxy settings will have a wider impact like not being able to connect to STS
	// This configures the address for the jwks server to listen for.
	// Optional. Defaults to the value of `listen_address`.
	JwksListenAddress string `protobuf:"bytes,15,opt,name=jwks_listen_address,json=jwksListenAddress,proto3" json:"jwks_listen_address,omitempty"`
	// The TCP port for the health server to listen for.
	// Optional. Defaults 10004.
	JwksListenPort int32 `protobuf:"varint,16,opt,name=jwks_listen_port,json=jwksListenPort,proto3" json:"jwks_listen_port,omitempty"`
	// The path for the health server to attend.
	// Optional. Defaults to "/.well-known/jwks.json".
	JwksListenPath string `protobuf:"bytes,17,opt,name=jwks_listen_path,json=jwksListenPath,proto3" json:"jwks_listen_path,omitempty"`
}
...
func (x *Config) GetJwksListenAddress() string {
	if x != nil {
		return x.JwksListenAddress
	}
	return ""
}

func (x *Config) GetJwksListenPort() int32 {
	if x != nil {
		return x.JwksListenPort
	}
	return 0
}

func (x *Config) GetJwksListenPath() string {
	if x != nil {
		return x.JwksListenPath
	}
	return ""
}
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x01, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x22, 0x9b, 0x06, 0x0a, 0x06, 0x43,
	...
	,
	...
	0x00, 0x52, 0x06, 0x73, 0x75, 0x66, 0x66, 0x69, 0x78, 0x12, 0x16, 0x0a, 0x05, 0x72, 0x65, 0x67,
	...
	,
